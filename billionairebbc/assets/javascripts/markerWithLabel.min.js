...
MarkerLabel_.getSharedCross = function (n) {
  var t;
  return (
    typeof MarkerLabel_.getSharedCross.crossDiv == 'undefined' &&
...
MarkerLabel_.prototype.onAdd = function () {
  ...
  typeof MarkerLabel_.getSharedCross.processed == 'undefined' &&
    (this.getPanes().overlayImage.appendChild(this.crossDiv_),
    (MarkerLabel_.getSharedCross.processed = !0));
  this.listeners_ = [
    google.maps.event.addListener(this.eventDiv_, 'mouseover', function (t) {
      (n.marker_.getDraggable() || n.marker_.getClickable()) &&
        ((this.style.cursor = 'pointer'),
        google.maps.event.trigger(n.marker_, 'mouseover', t));
    }),
    google.maps.event.addListener(this.eventDiv_, 'mouseout', function (i) {
      (n.marker_.getDraggable() || n.marker_.getClickable()) &&
        !t &&
        ((this.style.cursor = n.marker_.getCursor()),
        google.maps.event.trigger(n.marker_, 'mouseout', i));
    }),
    google.maps.event.addListener(this.eventDiv_, 'mousedown', function (i) {
      t = !1;
      n.marker_.getDraggable() && ((r = !0), (this.style.cursor = a));
      (n.marker_.getDraggable() || n.marker_.getClickable()) &&
        (google.maps.event.trigger(n.marker_, 'mousedown', i), e(i));
    }),
    google.maps.event.addListener(document, 'mouseup', function (e) {
      ...
      if (
        (r &&
          ((r = !1),
          (n.eventDiv_.style.cursor = 'pointer'),
          google.maps.event.trigger(n.marker_, 'mouseup', e)),
        t)
      ) {
        if (i) {
    ...
    google.maps.event.addListener(
      ...
      function (f) {
        ...
        r &&
          (t
            ? ((f.latLng = new google.maps.LatLng(
                f.latLng.lat() - s,
                f.latLng.lng() - h
              )),
              (e = n.getProjection().fromLatLngToDivPixel(f.latLng)),
              i &&
                ((n.crossDiv_.style.left = e.x + 'px'),
                (n.crossDiv_.style.top = e.y + 'px'),
                (n.crossDiv_.style.display = ''),
                (e.y -= u)),
              n.marker_.setPosition(n.getProjection().fromDivPixelToLatLng(e)),
              i && (n.eventDiv_.style.top = e.y + u + 'px'),
              google.maps.event.trigger(n.marker_, 'drag', f))
            : ((s = f.latLng.lat() - n.marker_.getPosition().lat()),
              (h = f.latLng.lng() - n.marker_.getPosition().lng()),
              (o = n.marker_.getZIndex()),
              (c = n.marker_.getPosition()),
              (l = n.marker_.getMap().getCenter()),
              (i = n.marker_.get('raiseOnDrag')),
              (t = !0),
              n.marker_.setZIndex(1e6),
              (f.latLng = n.marker_.getPosition()),
              google.maps.event.trigger(n.marker_, 'dragstart', f)));
      }
    ),
    google.maps.event.addListener(document, 'keydown', function (r) {
      t &&
        r.keyCode === 27 &&
        ((i = !1),
        n.marker_.setPosition(c),
        n.marker_.getMap().setCenter(l),
        google.maps.event.trigger(document, 'mouseup', r));
    }),
    google.maps.event.addListener(this.eventDiv_, 'click', function (t) {
      (n.marker_.getDraggable() || n.marker_.getClickable()) &&
        (f
          ? (f = !1)
          : (google.maps.event.trigger(n.marker_, 'click', t), e(t)));
    }),
    google.maps.event.addListener(this.eventDiv_, 'dblclick', function (t) {
      (n.marker_.getDraggable() || n.marker_.getClickable()) &&
        (google.maps.event.trigger(n.marker_, 'dblclick', t), e(t));
    }),
...
MarkerLabel_.prototype.setContent = function () {
  ...
  typeof n.nodeType == 'undefined'
    ? ((this.labelDiv_.innerHTML = n),
      (this.eventDiv_.innerHTML = this.labelDiv_.innerHTML))
    : ((this.labelDiv_.innerHTML = ''),
      this.labelDiv_.appendChild(n),
      (n = n.cloneNode(!0)),
      this.eventDiv_.appendChild(n));
};
...
MarkerLabel_.prototype.setStyles = function () {
  ...
  for (n in t)
    t.hasOwnProperty(n) &&
      ((this.labelDiv_.style[n] = t[n]), (this.eventDiv_.style[n] = t[n]));
...
MarkerLabel_.prototype.setZIndex = function () {
  ...
  typeof this.marker_.getZIndex() == 'undefined'
    ? ((this.labelDiv_.style.zIndex =
        parseInt(this.labelDiv_.style.top, 10) + n),
      (this.eventDiv_.style.zIndex = this.labelDiv_.style.zIndex))
    : ((this.labelDiv_.style.zIndex = this.marker_.getZIndex() + n),
      (this.eventDiv_.style.zIndex = this.labelDiv_.style.zIndex));
};
MarkerLabel_.prototype.setVisible = function () {
  this.labelDiv_.style.display = this.marker_.get('labelVisible')
    ? this.marker_.getVisible()
      ? 'block'
      : 'none'
    : 'none';
